...
export default function topContainer(){
   return(
    ...
    <div className="text__container relative ">
        ...
        <div className="absolute bottom-0 left-0 text-xl">Effortless</div>
        <div className="absolute bottom-0 right-0 text-xl">Accurate</div>
        <div className="flex m-auto text-3xl lg:text-4xl font-bold text-center text__container__center__heading">UNLEASH THE TRUE POWER OF LANGUAGE!</div>
